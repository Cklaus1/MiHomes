...
review paths were near-verbatim copies that drifted (WhatsApp's schema lost 8
categories); both now use the single superset implementation in
`services.gateways.review_common` so they can never diverge again.
"""
